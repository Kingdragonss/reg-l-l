...
'9': `<a:9_:809444399061794846>`}[d];
 ...
 const hgmesaj = (`
 <a:758209094673891348:814757537093910549>**__✵ Η Y Đ Я Λ'ya__** hoşgeldin <@${vader.id}> <a:758209094673891348:814757537093910549> 
 
 • <a:hydrayildizi3:791092780398673940> Seninle beraber sunucumuz `+üyesayısı+` kişiye ulaştı.  
 
 • <a:hydratac:789369824249643009> Hesabın **{`  + moment(member.user.createdAt).format("DD MMMM YYYY dddd") +`}** tarihinde oluşturuldu     
 
 • <a:hydrayildizi3:791092780398673940> `+ kontrol + `  
 
 • <a:hydratac:789369824249643009> Kaydını tamamlamak için herhangi bir **V.Confirmed** odasına girmen yeterlidir. 
 
 • <a:hydrayildizi3:791092780398673940> <@&${ayarlar.KayıtYetkilisi}> Rolüne sahip kişiler seninle ilgilenecektir.
 
 • <a:hydratac:789369824249643009> Tagımızı alarak ailemizin bir parçası olabilirsin.  
 
 • <a:hydrayildizi3:791092780398673940> Aramıza Hoşgeldin! <a:hydrarenklikalp:792002326285254666>`)
